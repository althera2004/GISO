										...
										<div class="tabbable">
											<ul class="nav nav-tabs padding-18">
												<li class="active">
													<a data-toggle="tab" href="#home">
														...
														<%=this.Dictionary["Datos principales"] %>
													</a>
												</li>

												<li class="">
													<a data-toggle="tab" href="#departments">
														<i class="green icon-list bigger-120"></i>
														<%=this.Dictionary["Departamentos"] %>
													</a>
												</li>
												...
												<li class="" id="TabHistoricoSelector">
													<a data-toggle="tab" href="#feed">
														...
														<%=this.Dictionary["Formación"] %>
													</a>
												</li>

												<li class="" id="Li1">
													<a data-toggle="tab" href="#trazas">
														<i class="orange icon-rss bigger-120"></i>
														<%=this.Dictionary["Formación interna"] %>
													</a>
												</li>
											...
											<div class="tab-content no-border padding-24" style="height:500px;">
											                    ...
											                    <table class="table table-bordered table-striped">
														                    <thead class="thin-border-bottom">
															                    <tr>
																                    ...
																                    <th class="hidden-480">
                                                                	                    <i class="icon-caret-right blue"></i>Responsable
																                    </th>
																                    <th class="hidden-480" style="width:120px;">
                                                                	                    <i class="icon-caret-right blue"></i>Fecha alta
																                    </th>
																                    <th class="hidden-480" style="width:120px;">
                                                                	                    <i class="icon-caret-right blue"></i>Fecha baja
																                    </th>													
															                    </tr>
														                    </thead>
														                    <tbody>
												...
												<div id="departments" class="tab-pane">	
                                                    ...
                                                    <h4 class="pink">
									                    <i class="icon-hand-right icon-animated-hand-pointer blue"></i>
									                    <a href="#" class="green" id="A1"> Associar a departament existent</a>
								                    </h4>
								                    <hr />												
											        <table class="table table-bordered table-striped">
														<thead class="thin-border-bottom">
