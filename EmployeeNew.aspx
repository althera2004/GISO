							...
							<ul class="pull-right dropdown-navbar navbar-pink dropdown-menu dropdown-caret dropdown-close">
									...
									<a href="#">
										<div class="clearfix">
											<span class="pull-left">
												<i class="btn btn-xs no-hover btn-pink icon-user"></i><%=this.Dictionary["Acceso no válido"] %>
											</span>
								...
								<li>
									<a href="#">
										<div class="clearfix">
											<span class="pull-left">
												<i class="btn btn-xs no-hover btn-success icon-user"></i><%=this.Dictionary["Documento obsoleto"] %>
											</span>
						...
						<div class="page-header">
							<h1>
								...
								<small>
									...
									<%=this.Dictionary["Añadir nuevo empleado"] %>
								</small>
							</h1>
						</div><!-- /.page-header -->
													...
													<div id="fuelux-wizard" class="row-fluid" data-target="#step-container">
														<ul class="wizard-steps">
															...
															<li data-target="#step3">
																...
																<span class="title">Asignación de usuario</span>
															</li>
													...
													<div class="step-content row-fluid position-relative" id="step-container">
														<div class="step-pane active" id="step1">
															...
															<form class="form-horizontal hide" id="validation-form" method="get">
																...
																<div class="form-group">
																	<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Primer apellido:</label>
																...
																<div class="space-2"></div>
																<div class="form-group">
																	<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Segundo apellido:</label>

																	<div class="col-xs-12 col-sm-9">
																		<div class="clearfix">
																			<input type="text" name="SecondLastName" id="SecondLastName" class="col-xs-12 col-sm-6" />
																		</div>
																	</div>
																</div>
